...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Kv2like G:/JHU/Study/Biomedical_Data_Design/neurosim/sim/dataset_build/morphologies/mouse_VISp_L5/spiny/neuronal_model_486508758/modfiles/Kv2like.mod\n");
