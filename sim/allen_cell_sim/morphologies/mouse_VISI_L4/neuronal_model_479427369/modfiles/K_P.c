...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 K_P G:/JHU/Study/Biomedical Data Design/neurosim/sim/allen_cell_sim/morphologies/mouse_VISI_L4/neuronal_model_479427369/modfiles/K_P.mod\n");
